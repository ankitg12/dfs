...
typedef struct sfs_file_entry
{
	...
	byte4_t blocks[SIMULA_FS_DATA_BLOCK_CNT]; /* Array of 4-byte indices of file's data "blocks" -> the number of data blocks each file can have is SIMULA_FS_DATA_BLOCK_CNT*/
} sfs_file_entry_t;
